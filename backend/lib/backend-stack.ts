...
export class MemoriesBackendStack extends Stack {
  ...
  constructor(app: App, id: string) {
    ...
    const uploadIntegration = new LambdaIntegration(this.uploadMessageFunction, {
      proxy: true,
    });
    ...
    const addFriendIntegration = new LambdaIntegration(this.addFriendFunction, {
      proxy: true,
    });
    ...
    accountResource.addResource("login").addMethod("POST", loginIntegration);
  }
}
