...
export class MemoriesBackendStack extends Stack {
  ...
  constructor(app: App, id: string) {
    ...
    this.getFriendListFunction = new Function(this, "GetFriendListFunction", {
    ...
    this.addNewAccountFunction = new Function(this, "AddNewAccountFunction", {
    ...
    userPool.addTrigger(UserPoolOperation.POST_CONFIRMATION, this.addNewAccountFunction);
    ...
    const uploadIntegration = new LambdaIntegration(this.uploadMessageFunction, { proxy: true });
    ...
    const addFriendIntegration = new LambdaIntegration(this.addFriendFunction, { proxy: true });
    accountResource.addResource("friend").addMethod("POST", addFriendIntegration);

    const getFriendsIntegration = new LambdaIntegration(this.getFriendListFunction);
